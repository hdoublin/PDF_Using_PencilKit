...
#ifndef PDFPENCILKIT_SWIFT_H
#define PDFPENCILKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PDFPencilKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12PDFPencilKit11AppDelegate")
...
SWIFT_CLASS("_TtC12PDFPencilKit13SceneDelegate") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified settingBtn;
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified plusBtnInSide;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified addBtnInSide;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified sideContainerView;
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified collectionView;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified plusBtnInContent;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified addBtnInContent;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified NewContainerView;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified newNoteBtn;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified importPdfBtn;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified closeBtn;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (IBAction)settingBtnPressed:(id _Nonnull)sender;
- (void)addBtnInSidePressed;
- (void)addBtnInContentPressed;
- (IBAction)newNoteBtnPressed:(id _Nonnull)sender;
- (IBAction)importPdfBtnPressed:(id _Nonnull)sender;
- (IBAction)closeBtnPressed:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface ViewController (SWIFT_EXTENSION(PDFPencilKit)) <UICollectionViewDataSource, UICollectionViewDelegate>
...
@interface ViewController (SWIFT_EXTENSION(PDFPencilKit)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC12PDFPencilKit11contentCell")
...
SWIFT_CLASS("_TtC12PDFPencilKit8sideCell")
